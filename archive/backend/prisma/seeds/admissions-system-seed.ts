/**
 * ScrollUniversity Admissions System Seed Data
...
export async function seedAdmissionsSystem() {
  console.log('🎓 Seeding ScrollUniversity Admissions System...');

  try {
    // Seed admissions configuration
    const admissionsConfigs = [
      // Application Settings
      {
        ...
        category: ConfigCategory.APPLICATION_SETTINGS
      },
      {
      ...
      // Assessment Criteria
      {
        ...
        category: ConfigCategory.ASSESSMENT_CRITERIA
      },
      {
      ...
      // Interview Configuration
      {
        ...
        category: ConfigCategory.INTERVIEW_CONFIGURATION
      },
      {
      ...
      // Decision Parameters
      {
        ...
        category: ConfigCategory.DECISION_PARAMETERS
      },
      {
      ...
      // Notification Settings
      {
        ...
        category: ConfigCategory.NOTIFICATION_SETTINGS
      },
      {
      ...
      // System Parameters
      {
        ...
        category: ConfigCategory.SYSTEM_PARAMETERS
      },
      {
