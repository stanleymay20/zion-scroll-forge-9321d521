...
exports.validateAnalyticsImplementation = validateAnalyticsImplementation;
const AdmissionsAnalyticsService_1 = require("../src/services/admissions/AdmissionsAnalyticsService");
const PerformanceTrackingService_1 = __importDefault(require("../src/services/admissions/PerformanceTrackingService"));
async function validateAnalyticsImplementation() {
    console.log('🔍 Validating Admissions Analytics Implementation...\n');
    try {
        console.log('✅ Testing service instantiation...');
        const analyticsService = new AdmissionsAnalyticsService_1.AdmissionsAnalyticsService();
        const performanceService = new PerformanceTrackingService_1.default();
        ...
        for (const method of performanceMethods) {
            if (typeof performanceService[method] === 'function') {
...
//# sourceMappingURL=validate-admissions-analytics.js.map