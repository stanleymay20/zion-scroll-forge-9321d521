...
const predictiveAnalyticsService = new PredictiveAnalyticsService_1.default();
class PredictiveAnalyticsValidator {
    ...
    async validateAdmissionSuccessModel() {
    ...
    async validateEnrollmentForecast() {
    ...
    async validateProcessImprovement() {
...
exports.default = PredictiveAnalyticsValidator;
//# sourceMappingURL=validate-predictive-analytics.js.map