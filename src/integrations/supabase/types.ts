...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      course_sections: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "course_sections_program_id_fkey"
            columns: ["program_id"]
            isOneToOne: false
            referencedRelation: "accreditation_baseline_report"
            referencedColumns: ["id"]
      ...
      section_enrollments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "section_enrollments_term_id_fkey"
            columns: ["term_id"]
            isOneToOne: false
            referencedRelation: "academic_terms"
            referencedColumns: ["id"]
      ...
      student_outcome_mastery: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_outcome_mastery_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "courses"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_outcome_mastery_learning_objective_id_fkey"
            columns: ["learning_objective_id"]
            isOneToOne: false
            referencedRelation: "course_learning_outcomes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_outcome_mastery_module_id_fkey"
            columns: ["module_id"]
            isOneToOne: false
            referencedRelation: "course_modules"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      student_schedule_v: {
        Row: {
          ...
          starts_on: string | null
          status:
            | Database["public"]["Enums"]["section_enrollment_status"]
            | null
          student_user_id: string | null
          term_id: string | null
    ...
    Functions: {
      ...
      promote_waitlist: { Args: { _section_id: string }; Returns: string }
