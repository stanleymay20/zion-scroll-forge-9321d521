...
-- Align simulate_cohort with cohort_simulation_runs CHECK constraints
-- status: running | completed | failed
-- verdict: ready_pilot | ready_limited_prod | needs_stabilization
