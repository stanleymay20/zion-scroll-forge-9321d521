...
DROP POLICY IF EXISTS "Course modules readable only by enrolled course members" ON public.course_modules;
...
DROP POLICY IF EXISTS "Learning materials readable only by enrolled course members" ON public.learning_materials;
...
DROP POLICY IF EXISTS "Course materials readable only by enrolled course members" ON public.course_materials;
